...
if (!global.DATABASE.data.stats) global.DATABASE.data.resources = {}
if (!global.DATABASE.data.stats) global.DATABASE.data.courses = {}
...
global.reloadHandler = function () {
  ...
  conn.welcome = 'ᴏʜᴀʏᴏ, @user!\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ @subject ɢʀᴏᴜᴘ.\nᴘʟᴇᴀꜱᴇ ꜰᴏʟʟᴏᴡ ɢʀᴏᴜᴘ ʀᴜʟᴇꜱ ꜱᴛʀɪᴄᴛʟʏ.\nᴍᴀɪɴᴛᴀɪɴ ᴅɪꜱᴄɪᴘʟɪɴᴇ\nʀᴇᴀᴅ ɢʀᴏᴜᴘ ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ ꜰɪʀꜱᴛ.\nɪꜰ ʏᴏᴜ ʙʀᴇᴀᴋ ʀᴜʟᴇꜱ ʙᴏᴛ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴋɪᴄᴋ ʏᴏᴜ ꜰʀᴏᴍ ɢʀᴏᴜᴘ.'
  conn.bye = 'ɢᴏᴏᴅʙʏᴇ @user.\nʏᴏᴜ ᴡɪʟʟ ɴᴏᴛ ʙᴇ ᴍɪꜱꜱᴇᴅ.!'
