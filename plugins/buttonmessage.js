...
// send a owner no message!
  ...
  if(m.mtype == "buttonsResponseMessage"){
    if(m.msg.selectedButtonId == "owner"){
        conn.sendContact(m.chat, '+923178022596', 'ZTEch', m)
 ...
 // send pwd msg!
        ...
        // send a wiresharks course message!
          }else  if(m.msg.selectedButtonId == "WireSharkCourse"){
        conn.reply(m.chat,'🎀💮WIRESHARK TUTORIAL – GET WIRESHARK CERTIFICATION🎀💮\n🎀💮Know how to download Wireshark🎀💮\n🎀💮Understand how to setup and use Wireshark🎀💮\nNavigate the Wireshark interface🎀💮\n🎀💮Learn the various filters available in Wireshark🎀💮\n🎀💮Use CLI and Tshark🎀💮\n🎀💮How to export data from Wireshark🎀💮\nhttps://mega.nz/folder/sX4QCACb#20UvcYGPYH8fq0zqDyFxyQ\n', m)
        
        // send a hacking courses2 message!
          }else  if(m.msg.selectedButtonId == "HackingCourses2"){
        conn.reply(m.chat,'#oldbutgold\nSharing the most advance ethical hacking bible\n🍎Topics 🍎\n🍍Ethical Hacking\n🍍Python Guide\n🍍Cryptography\n🍍Rats and Worms\n🍍Sql injection\n🍍Mobile Hacking\n🍒LINK= https://mega.nz/folder/Rv5WnTbK#HdhVC6IVThbtHzqsU_Fh0gKEY=HdhVC6IVThbtHzqsU_Fh0g', m)
