...
${arr.slice(3, 6).join('')}
${arr.slice(6).join('')}
${isWin ? `@${winner.split('@')[0]} 🔖Wew He Won🔖! (+${winScore} 🔖XP🔖)` : isTie ? `🔖Game Tied Well Played🔖 (+${playScore} 🔖XP🔖)` : `🔖Turn🔖 ${['❌', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`}
❌: @${room.game.playerX.split('@')[0]}
⭕: @${room.game.playerO.split('@')[0]}
When thinking of giving up type *give up* to give up.
Room ID: ${room.id}
`.trim()
